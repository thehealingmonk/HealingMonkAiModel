...
import { Search, UserPlus, ChevronRight, Users, SlidersHorizontal } from 'lucide-react';
...
export default function DoctorDashboard({ onRegister, onOpenPatient, onManagePositions }: Props) {
    ...
    <div className="hm-page-enter max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6" data-reveal="fade">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <SlidersHorizontal className="w-4 h-4" /> Default positions
          </button>
          <button
            onClick={onRegister}
